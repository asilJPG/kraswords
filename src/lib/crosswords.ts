...
export const crosswords: CrosswordData[] = [
  ...
  // ═══════════ КОСМОС ═══════════
  cw('7', 'Звёздные тайны', 'космонавт', '2026-06-07', 'лёгкий', '🌌', 'Космос', 4103, themes.space, [
  ...
  cw('8', 'Далёкие галактики', 'астроном', '2026-06-01', 'средний', '🔭', 'Космос', 2760, themes.space, [
  ...
  cw('9', 'Чёрные дыры', 'хокинг', '2026-05-27', 'сложный', '⚫', 'Космос', 980, themes.space, [
  ...
  // ═══════════ ПРИРОДА ═══════════
  cw('10', 'Живой мир', 'биолог', '2026-06-06', 'лёгкий', '🌿', 'Природа', 5671, themes.nature, [
  ...
  cw('11', 'Океан', 'моряк', '2026-05-31', 'средний', '🐚', 'Природа', 3200, themes.nature, [
  ...
  cw('12', 'Горы и реки', 'путник', '2026-05-25', 'сложный', '🏔️', 'Природа', 1150, themes.nature, [
  ...
  // ═══════════ РЕТРО ═══════════
  cw('13', 'Пиксельные герои', 'геймер', '2026-06-05', 'сложный', '👾', 'Ретро', 1412, themes.retro, [
  ...
  cw('14', 'Аркадные ночи', 'олдскул', '2026-05-29', 'средний', '🕹️', 'Ретро', 2340, themes.retro, [
  ...
  // ═══════════ КЛАССИКА ═══════════
  cw('15', 'Классика слов', 'редакция', '2026-06-04', 'лёгкий', '📝', 'Классика', 6893, themes.default, [
  ...
  cw('16', 'Города мира', 'редакция', '2026-05-26', 'средний', '🗺️', 'Классика', 3890, themes.default, [
