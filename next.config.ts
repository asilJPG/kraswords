        ...
        headers: [
          {
            ...
            // unsafe-eval удалён — он не нужен и открывает XSS.
            // unsafe-inline оставлен для совместимости с Next.js hydration.
            // Для полной защиты используйте nonce-based CSP.
